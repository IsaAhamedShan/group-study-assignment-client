  ...
  return (
    <div className="bg-base-100 h-full py-6 md:py-0">
      <div className="about-us-container p-8 overflow-auto max-h-full">
        <h2 className="text-xl md:text-3xl font-bold mb-4">About Us</h2>
        ...
        <p className="mb-4 text-sm md:text-base hidden md:block">
        ...
        <p className="text-sm md:text-base">Thank you for choosing our platform. Happy studying!</p>
      </div>
    </div>
  );
};
